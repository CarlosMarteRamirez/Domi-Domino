...
-- CreateEnum
CREATE TYPE "BlockMode" AS ENUM ('individual', 'parejas');

-- CreateEnum
CREATE TYPE "TeamSelection" AS ENUM ('manual', 'auto');
...
CREATE TABLE "Room" (
    ...
    "blockMode" "BlockMode" NOT NULL DEFAULT 'parejas',
    "passBonus" INTEGER NOT NULL DEFAULT 25,
    "teamSelection" "TeamSelection" NOT NULL DEFAULT 'auto',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
